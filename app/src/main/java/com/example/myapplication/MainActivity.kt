...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        items.add(TxtItem(1, "Homework"))
        items.add(TxtItem(2, "idk"))
        items.add(FolderItem(3, "Tasks"))
        items.add(FolderItem(4, "Notes"))
        items.add(FolderItem(5, "Homeworks"))
        items.add(FolderItem(6, "Books"))
        items.add(TxtItem(1, "Homework"))
        items.add(TxtItem(2, "idk"))
        items.add(FolderItem(3, "Tasks"))
        items.add(FolderItem(4, "Notes"))
